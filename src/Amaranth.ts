...
export const aiArrowDownLeftArrowUpRightToCenter: {
  name: 'arrow_down_left_arrow_up_right_to_center';
  data: string;
} = {
  name: 'arrow_down_left_arrow_up_right_to_center',
...
export const aiClearFormatting: {
...
export const aiItalic: {
  ...
  name: 'italic',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 16" fill="currentColor"><path fill-rule="evenodd" d="M10.97 2.5H9.75a.75.75 0 0 1 0-1.5h4.5a.75.75 0 0 1 0 1.5h-1.7l-3.52 11h1.22a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5h1.7l3.52-11Z"/></svg>`
};
...
export type Amaranth =
  ...
  | 'angle_right'
  | 'angle_up'
  | 'arrow_down_left_arrow_up_right_to_center'
  | 'arrow_down_to_line'
  | 'arrow_down'
...
export const completeIconSet = [
  ...
  aiAngleRight,
  aiAngleUp,
  aiArrowDownLeftArrowUpRightToCenter,
  aiArrowDownToLine,
  aiArrowDown,
